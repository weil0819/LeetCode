...
https://www.leetfree.com/problems/average-salary-departments-vs-company.html
...
# compute the department's average salary
select department_id, date_format(pay_date, '%Y-%M') as pay_month, avg(amount) as department_avg
